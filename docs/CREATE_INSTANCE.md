...
| Elemen | Deskripsi |
|---|---|
| App info | Ikon, nama app, package name (ter-prefill dari AppsScreen) |
| Toggle opsi | Konfigurasi per-instance yang bisa diaktifkan/nonaktifkan |
...
| Enable Anti-Detection | Aktifkan PackageManager hiding, file system hook, stack trace filter |
